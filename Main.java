   ...
   //                }
         ...
         //System.out.println("[**] INBOX  " + xBox);
                                  ...
                                  // System.out.println("XBOX ::::: " + xBox);
                                        ...
                                        //  System.out.println("SPALT ::::: " + slicerPalet +  "  slicerPalet.get(e)  " + slicerPalet.get(e) + "   xBox.get(f) ::::: " + xBox.get(f)+ "  IF= slicerPalet.get(e).get(0) ::::: "+ slicerPalet.get(e).get(0));
                                            
                                            if((int)slicerPalet.get(e).get(0) == (int)xBox.get(f) ){ //second argument might be deleted  && e < slicerPalet.size()
                                                  //   System.out.println("HOWOOO");
                                                           if(comboBox.size() == 0){
